...
function find(selector, context = doc) {
    return !isDocument(context) && !isElement$1(context)
        ? []
...
var ResizePanel = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(ResizePanel, [{
    ...
    value: function handleDrag(e, ui) {
      ...
      var delta = this.isHorizontal() ? ui.deltaX : ui.deltaY;
    ...
    value: function render() {
      ...
      var handle = /*#__PURE__*/React.createElement(DraggableCore_1$1, _extends({
        key: "handle"
      }, dragHandlers), /*#__PURE__*/React.createElement("div", {
